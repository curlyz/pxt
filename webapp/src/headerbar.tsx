...
export class HeaderBar extends data.Component<ISettingsProps, {}> {
    ...
    getOrganizationLogo(targetTheme: pxt.AppTheme, highContrast?: boolean, view?: string) {
        ...
        return (
          ...
          >
            ...
            {targetTheme.organizationLogo && view !== "home" && (
              <img
    ...
    getTargetLogo(targetTheme: pxt.AppTheme, highContrast?: boolean, view?: string) {
        ...
        return (
          <div
            aria-label={lf("{0} Logo", targetTheme.boardName)}
            role="menuitem"
            className={`ui item logo brand ${
              view !== "sandbox" && view !== "home" ? "mobile fhide" : ""
            }`}
            onClick={this.brandIconClick}
          >
            {targetTheme.useTextLogo ? (
              ...
              <img
                className={`ui ${targetTheme.logoWide ? "small" : ""} logo`}
    ...
    renderCore() {
        ...
        return <div id="mainmenu" className={`ui borderless fixed menu ${targetTheme.invertedMenu ? `inverted` : ''} ${manyTutorialSteps ? "thin" : ""}`} role="menubar">
            ...
            <div className="right menu">
                ...
                {/* // gb.override : change the behaviour of share button  */}
                {showShareButton && <sui.Item className="icon shareproject mobile hide" role="menuitem" title={lf("Publish your game to create a shareable link")} icon="share alternate large" ariaLabel={lf("Share Project")} onClick={() => (window as any).__link_handle_share_project__()} />}
